...
export default function Cart() {
  ...
  return (
    <div className="container">
      <h2 className="text-2xl text-center font-bold mt-8  text-green-500">
        Shopping Cart
      </h2>
      <h4 className="text-center mb-8 mt-4 text-xl ">
        Total Price{" "}
        <span className="font-bold">{allData.totalCartPrice} EGP</span>
      </h4>
      <div className="flex justify-end">
        {" "}
        <Link to={"/checkout"} className="bg-green-500 p-2 rounded  my-2 ">
          Checkout
        </Link>
      </div>
